...
def user(request, username=None):
    ...
    content = {'auth_user': request.user, 'user': user, 'is_self': request.user == user, 'quarterly_overall': quarterly_overall, 'quarterly_grade': quarterly_grade, 'alltime_overall': alltime_overall, 'alltime_grade': alltime_grade}
